    ...
    CommandLineRunner initDatabase(TicketDAO ticketDAO, ProductDAO productDAO, ProductVersionDAO productVersionDAO) {
        return args -> {
            if (productDAO.count() == 0) {
                ...
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(2L).build()).version("2023 Wave 2").build());
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(2L).build()).version("2023 Wave 1").build());
                ...
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(5L).build()).version("2023.3").build());
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(5L).build()).version("2022.4").build());
                ...
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(7L).build()).version("5.8").build());
                ...
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(9L).build()).version("4.4.5").build());
                ...
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(13L).build()).version("2023.4").build());
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(13L).build()).version("2023.2").build());
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(13L).build()).version("2023.1").build());
                ...
                productVersionDAO.save(ProductVersionEntity.builder().producto(ProductEntity.builder().id(14L).build()).version("2023 Summer Release").build());
