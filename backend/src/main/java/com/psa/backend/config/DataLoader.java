...
public class DataLoader {
        ...
        @Bean
        CommandLineRunner initDatabase(TicketDAO ticketDAO, ProductDAO productDAO,
                        ProductVersionDAO productVersionDAO) {
                return args -> {
                        if (productDAO.count() == 0) {
                                productDAO.save(ProductEntity.builder().prefix("OEC").nombre("Oracle ERP Cloud")
                                                .build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(1L).build())
                                                .version("23C").build());
                                productDAO.save(ProductEntity.builder().prefix("MD365").nombre("Microsoft Dynamics 365")
                                                .build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(2L).build())
                                ...
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(3L).build())
                                ...
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(4L).build())
                                                .version("Paris").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(4L).build())
                                ...
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(5L).build())
                                ...
                                productDAO.save(ProductEntity.builder().prefix("SEG").nombre("Slack Enterprise Grid")
                                                .build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(6L).build())
                                                .version("23.01").build());
                                productDAO.save(ProductEntity.builder().prefix("ZES").nombre("Zendesk Support")
                                                .build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(7L).build())
                                                .version("6.0").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(7L).build())
                                                .version("5.9").build());
                                ...
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(8L).build())
                                                .version("2024.1").build());
                                productDAO.save(ProductEntity.builder().prefix("HSC").nombre("HubSpot CRM").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(9L).build())
                                                .version("4.5.1").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(9L).build())
                                                .version("4.4.9").build());
                                ...
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(10L).build())
                                                .version("9.4.0").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(10L).build())
                                                .version("9.3.1").build());
                                productDAO.save(ProductEntity.builder().prefix("GOOW").nombre("Google Workspace")
                                                .build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(11L).build())
                                                .version("2024.05").build());
                                productDAO.save(ProductEntity.builder().prefix("CONF").nombre("Confluence").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(12L).build())
                                                .version("8.11.0").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(12L).build())
                                                .version("8.10.0").build());
                                productDAO.save(ProductEntity.builder().prefix("ONSE").nombre("Oracle NetSuite")
                                                .build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(13L).build())
                                                .version("2024.1").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(13L).build())
                                ...
                                productDAO.save(ProductEntity.builder().prefix("SALC").nombre("Salesforce CRM")
                                                .build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(14L).build())
                                ...
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(15L).build())
                                                .version("7.50").build());
                                productVersionDAO.save(ProductVersionEntity.builder()
                                                .producto(ProductEntity.builder().id(15L).build())
                                                .version("7.51").build());
                        ...
                        if (ticketDAO.count() == 0 && productVersionDAO.count() != 0) {
