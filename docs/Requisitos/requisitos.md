...
| RF1.4   | Registro de horas trabajadas                             | Registrar horas trabajadas por miembros asignados en proyectos activos                                           | Funcional            | RF1.3      | Alta      |
...
| RNF4    | Compatibilidad con otras plataformas                     | Los datos con los que trabajará el esistema deberán poder ser importados o exportados desde otras aplicaciones   | No Funcional         |            | Baja      |
