...
| RF4.1   | Intercambio de datos con Microsoft Project               | Importar y exportar información de planificación y seguimiento hacia y desde Microsoft Project.                  | Funcional            | RF4        | Baja      |
| RF4.2   | Exportación a Excel                                      | Permitir exportar datos en formato compatible con Excel                                                          | Funcional            | RF4        | Baja      |
